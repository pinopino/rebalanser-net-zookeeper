...
namespace Rebalanser.Core
{
    ...
    {
        private ZooKeeperProvider rebalanserProvider;
        private CancellationTokenSource cts;

        public RebalanserClient(string zookeeperHosts,
        ...
        {
            this.rebalanserProvider = new ZooKeeperProvider(zookeeperHosts,
                zooKeeperRootPath, sessionTimeout, connectTimeout, minRebalancingInterval, logger, zooKeeperService);
        }
